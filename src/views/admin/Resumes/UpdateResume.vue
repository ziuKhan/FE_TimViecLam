            ...
            <a-row :gutter="16">
                <a-col :span="24">
                    <a-form-item label="Email" name="email"
                        :rules="[{ required: true, message: 'Vui lòng nhập địa chỉ email!' }, { type: 'email', message: 'Email không hợp lệ' }]">
                        <a-input v-model:value="store.form.email" placeholder="Vui lòng nhập email" />
                    </a-form-item>
                </a-col>
                <a-col :span="12">
                    <a-form-item label="Tải lên CV" name="url"
