...
<template>
  <a-modal
    :title="store.form._id ? 'Cập nhật thông báo' : 'Tạo mới thông báo'"
    ...
    <a-form :model="store.form" ref="formRef" layout="vertical">
      <a-row :gutter="16">
        ...
        <a-col :span="24">
          ...
          >
            <a-textarea
              v-model:value="store.form.message"
        ...
        <a-col :span="12">
          ...
          >
            <a-select
              v-model:value="store.form.type"
              allowClear
              style="width: 100%"
              placeholder="Vui lòng chọn loại thông báo..."
              :options="TYPES_NOTIFICATION_LIST"
            >
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item name="userId">
            <template #label>
              ...
              <a-checkbox
                :disabled="store.form.userIds?.length"
                v-model:checked="store.form.isGlobal"
                >Gửi tất cả</a-checkbox
              >
            </template>
            <a-select
              :disabled="store.form.isGlobal"
              mode="multiple"
              v-model:value="store.form.userIds"
              allowClear
              style="width: 100%"
