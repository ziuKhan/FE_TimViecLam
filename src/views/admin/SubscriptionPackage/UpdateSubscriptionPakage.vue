<template>
    <a-modal :title="store.form._id ? 'Cập nhật gói dịch vụ' : 'Tạo mới gói dịch vụ'" :width="800" 
        :body-style="{ paddingBottom: '80px' }" :footer-style="{ textAlign: 'right' }" v-model:open="store.openModal"
        :maskClosable="false">
            ...
            <a-row :gutter="16">
                ...
                <a-col :span="12">
                    <a-form-item label="Giá" name="price">
                        <a-input-number v-model:value="store.form.price" placeholder="Vui lòng nhập giá"  class="w-full" :min="1" />
                    </a-form-item>
                </a-col>
                <a-col :span="12">
                    <a-form-item label="Giá sau khi giảm" name="priceDiscount">
                        <a-input-number v-model:value="store.form.priceDiscount" placeholder="Vui lòng nhập giá sau khi giảm" class="w-full" :min="1" :max="store.form.price" />
                    </a-form-item>
                </a-col>
                <a-col :span="20">
                    <a-form-item label="Thời hạn (Tháng)" name="duration">
                        <a-input-number :min="1" v-model:value="store.form.duration" placeholder="Vui lòng nhập thời hạn" class="w-full" />
                    </a-form-item>
                </a-col>
                <a-col :span="4">
