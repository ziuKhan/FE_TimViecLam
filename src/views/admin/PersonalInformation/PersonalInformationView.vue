...
const loadData = async () => {
  const [companyRes] = await Promise.all([apiService.get('companies/' + account?.companyId)])
          ...
          <div class="flex justify-between items-center px-8 py-6 border-b border-gray-100">
            ...
            <div>
              ...
              <div v-if="isEditCompany" class="flex gap-2">
                ...
                <a-button type="primary" @click="updateCompany(companyInfo?._id || '')">
                  Lưu thay đổi
                </a-button>
              </div>
            </div>
              ...
              <div v-if="!isEditCompany">
                <div class="mb-8">
                  ...
                  <div class="grid grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <p class="mt-1 text-base text-gray-900">
                        {{ companyInfo?.type || 'Chưa cập nhật' }}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="mb-8">
                  ...
                  <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                      ...
                      >
                      <p class="mt-1 text-base text-gray-900">
                        {{ companyInfo?.detailedAddress || 'Chưa cập nhật' }}
                      </p>
                    </div>
                    <div class="col-span-2">
                      <label class="block text-sm font-medium text-gray-500"
                        >Địa chỉ các văn phòng</label
                      >
                      <p class="mt-1 text-base text-gray-900">
                        {{
                          companyInfo?.address?.length
                ...
                <div class="mb-8">
                  ...
                  <div class="grid grid-cols-2 gap-6">
                    <div>
                      ...
                      <p class="mt-1 text-base text-gray-900">
                        {{
                          companyInfo?.workingDays?.length
                            ? companyInfo?.workingDays?.join(', ')
                            : 'Chưa cập nhật'
                        }}
                      </p>
                    </div>
                    <div>
                      <label class="block text-sm font-medium text-gray-500"
                        >Chính sách làm thêm giờ</label
                      >
                      <p class="mt-1 text-base text-gray-900">
                        {{ companyInfo?.overtimePolicy || 'Chưa cập nhật' }}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div
                    ...
                    v-html="companyInfo?.description || 'Chưa cập nhật'"
                  ></div>
                </div>
              </div>
            ...
            <div class="w-1/3">
              <div class="bg-gray-50 rounded-lg p-6 sticky top-6">
                <div class="flex flex-col items-center mb-4">
                  <div
                    class="mb-4 w-40 h-40 overflow-hidden rounded-lg shadow-sm border border-gray-200"
                  >
                    <img
                        ...
                        <p class="text-sm text-gray-700">
                          {{
                            companyInfo?.updatedAt
                              ? format(new Date(companyInfo.updatedAt), 'dd/MM/yyyy')
                              : 'Chưa cập nhật'
                          }}
                        </p>
                      </div>
  ...
  >
    <div class="flex flex-col items-center w-full">
      ...
      <div class="flex justify-end gap-2 w-full">
        ...
        <a-button type="primary" @click="handleConfirmUpload('company')" :disabled="!selectedFile">
          Xác nhận
        </a-button>
      </div>
    </div>
