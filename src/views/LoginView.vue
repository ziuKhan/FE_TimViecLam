...
<template>
    <div class="container__login">
        ...
        <div class="leftSide">
            ...
            <a-button danger class="login__btn_google"><img src="../assets/image/icon/icons8_google.svg" alt=""> Đăng nhập với Google</a-button>
  ...
  >
    ...
    <div class="rightSide">
      <div class="rightSide__title">Đăng nhập để truy cập ngay vào hàng ngàn đánh giá và dữ liệu lương thị trường IT</div>
      <div class="rightSide__part"><img src="../assets/image/icon/icons8_checkmark.svg" alt="">Xem trước mức lương để có thể lợi thế khi thoả thuận lương</div> 
      <div class="rightSide__part"><img src="../assets/image/icon/icons8_checkmark.svg" alt="">Tìm hiểu về phúc lợi, con người, văn hóa công ty qua các đánh giá chân thật      </div> 
      <div class="rightSide__part"><img src="../assets/image/icon/icons8_checkmark.svg" alt="">Dễ dàng ứng tuyển chỉ với một thao tác</div> 
      <div class="rightSide__part"><img src="../assets/image/icon/icons8_checkmark.svg" alt="">Quản lý hồ sơ và quyền riêng tư của bạn</div> 
    </div>
    </div>
</template>
