  ...
  >
    ...
    >
      ...
      <div class="success-icon relative mb-6 mx-auto">
        <div
          class="animate-success-ring w-24 h-24 rounded-full border-4 border-green-500 flex items-center justify-center"
        >
      ...
      <div class="countdown-container relative mb-6">
        <div
          class="countdown-circle mx-auto w-16 h-16 rounded-full flex items-center justify-center border-4 border-blue-500"
        >
      ...
      <button
        @click="goToHome"
        class="relative bg-blue-600 hover:bg-blue-700 text-white py-3 px-8 rounded-lg font-medium transition duration-300"
      >
        Về trang chủ ngay
      </button>
