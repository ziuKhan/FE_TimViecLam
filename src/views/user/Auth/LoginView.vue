...
<template>
  ...
  <div class="container__login h-screen">
    ...
    <div class="leftSide w-full lg:w-2/4 mx-auto lg:pr-[120px]">
      ...
      <a-button danger class="login__btn_google" @click="onLoginByGoogle()">
        <img loading="lazy" src="../../../assets/image/icon/icons8_google.svg" alt="" /> Đăng nhập
        với Google</a-button
      >
      ...
      >
        ...
        <a-form-item>
          ...
          hoặc
          <RouterLink to="/register" class="font-medium hover:text-red-600"
    ...
    <div class="rightSide w-full lg:w-2/4">
      ...
      <div class="rightSide__part">
        <img loading="lazy" src="../../../assets/image/icon/icons8_checkmark.svg" alt="" />Xem trước
        mức lương để có thể lợi thế khi thoả thuận lương
      </div>
      <div class="rightSide__part">
        <img loading="lazy" src="../../../assets/image/icon/icons8_checkmark.svg" alt="" />Tìm hiểu
        về phúc lợi, con người, văn hóa công ty qua các đánh giá chân thật
      </div>
      <div class="rightSide__part">
        <img loading="lazy" src="../../../assets/image/icon/icons8_checkmark.svg" alt="" />Dễ dàng
        ứng tuyển chỉ với một thao tác
      </div>
      <div class="rightSide__part">
        <img loading="lazy" src="../../../assets/image/icon/icons8_checkmark.svg" alt="" />Quản lý
        hồ sơ và quyền riêng tư của bạn
      </div>
    </div>
  </div>
</template>
