...
<template>
  ...
  <div v-else>
    <div class="flex">
      <div class="w-1/2 theme_blackred hidden lg:block">
        <img loading="lazy" src="../../../assets/image/company/logo_login_customer.png" alt="" />
      </div>
      <div class="w-full lg:w-1/2">
        <div class="w-[90%] lg:w-[65%] mx-auto my-[16vh]">
          <div class="flex gap-x-4 text-base font-bold items-center">
            <img
              loading="lazy"
              class="w-[108px]"
              src="../../../assets/image/icon/logo-itviec-black.png"
              alt=""
            />
          ...
          >
            ...
            <div class="mt-3 flex justify-between">
              ...
              <RouterLink to="/forgotpassword" class="text-[#0E2EED] text-sm font-normal"
                >Quên mật khẩu
              </RouterLink>
            </div>
            <div class="mt-4 text-sm font-light">
              Bằng việc đăng nhập, bạn đồng ý với các
              <span class="text-[#0E2EED]">Điều khoản dịch vụ </span>và
              <span class="text-[#0E2EED]"> Chính sách quyền riêng tư</span> của ITviec liên quan
            ...
            <a-button
              ...
              html-type="submit"
              :loading="loading"
              class="w-full mt-8 h-[40px] lg:h-[50px] text-lg bg-red-600 text-white rounded-[4px] hover:bg-red-700"
              >Đăng nhập</a-button
            >
          </a-form>
          <div class="text-[16px] mt-3 font-light text-center">
            ...
            <RouterLink
              ...
              class="text-[#0E2EED] hover:text-[#210eed] hover:font-[400]"
