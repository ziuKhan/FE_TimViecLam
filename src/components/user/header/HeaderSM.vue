...
<template>
  ...
  >
    <button class="w-8 h-full p-1" @click="openMenu = true">
      <img
        loading="lazy"
        class="h-full object-contain"
        src="../../../assets/image/icon/icons8_menu.svg"
        alt="#"
      />
    </button>
  ...
  >
    <div class="flex flex-col">
      <RouterLink to="" class="header__nav_link pl-3 py-4 hover:text-red-600">
        Việc làm IT</RouterLink
      >
      <RouterLink to="" class="header__nav_link pl-3 py-4 hover:text-red-600">
        Việc làm IT</RouterLink
      >
  ...
  >
    <div class="flex flex-col">
      <span to="" @click="openNotification = true" class="header__nav_link pl-3 py-4"
        >4 Thông báo</span
      >
