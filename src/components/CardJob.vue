...
<template>
    <div class="w-full rounded-md bg-white h-28 border border-solid border-gray-300 hover:bg-zinc-100 hover:border-zinc-300 flex gap-2 p-3 group" >
        ...
        <div class="w-full flex flex-col overflow-hidden">
            <RouterLink :to="`/job/${_id}`" class="w-full text-base font-medium group-hover:text-red-800 truncate ">
               {{ name }}
            </RouterLink>
